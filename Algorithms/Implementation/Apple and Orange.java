...
public class Solution {
    ...
    static void countApplesAndOranges(int s, int t, int a, int b, int[] apples, int[] oranges) {
        ...
        long applesAtHouseCount = Arrays.stream(apples)
                                        .filter(x -> x + a >= s && x + a <= t)
                                        .count();
        long orangesAtHouseCount = Arrays.stream(oranges)
                                        .filter(x -> x + b >= s && x + b <= t)
                                        .count();
        
        System.out.println(applesAtHouseCount);
        System.out.println(orangesAtHouseCount);
    }
